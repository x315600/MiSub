...
<template>
  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-xs border border-gray-100 dark:border-gray-700">
      ...
      <p class="text-xl font-bold text-gray-900 dark:text-white">{{ activeSubscriptionsCount }} <span class="text-sm font-normal text-gray-400">/ {{ subscriptionsCount }}</span></p>
    ...
    <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-xs border border-gray-100 dark:border-gray-700">
      ...
      <p class="text-xl font-bold text-gray-900 dark:text-white">{{ activeProfilesCount }}</p>
