...
<template>
  <div class="space-y-6">
    <!-- 订阅基本信息配置 -->
    <div class="bg-white dark:bg-gray-800 rounded-lg p-0 space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div>
          ...
          <input type="text" v-model="settings.FileName" class="block w-full px-3 py-2 bg-gray-50 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-600 rounded-md shadow-xs focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:text-white transition-colors">
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">自定义订阅Token</label>
          <input type="text" v-model="settings.mytoken" class="block w-full px-3 py-2 bg-gray-50 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-600 rounded-md shadow-xs focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:text-white transition-colors">
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">订阅组分享Token</label>
          <input type="text" v-model="settings.profileToken" placeholder="用于生成订阅组链接专用Token" class="block w-full px-3 py-2 bg-gray-50 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-600 rounded-md shadow-xs focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:text-white transition-colors">
        </div>
      </div>
    </div>
    ...
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <!-- 访问日志 -->
        <div class="flex items-center justify-between p-4 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-lg shadow-xs hover:shadow-sm transition-shadow">
          <div>
    ...
    <div class="space-y-4">
      ...
      <div class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-lg shadow-sm divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden">
        <!-- 公开页访问 -->
        ...
        <div class="p-4 space-y-4">
          ...
          <!-- 伪装详细配置 -->
          <div v-show="disguiseConfig.enabled" class="bg-gray-50 dark:bg-gray-900/50 rounded-md p-4 space-y-4 border border-gray-100 dark:border-gray-700/50 transition-all duration-300">
             <div>
               ...
               <div class="flex flex-col sm:flex-row gap-4">
                 <label class="flex items-center cursor-pointer group">
                   ...
                   <div class="ml-3">
                      <span class="block text-sm font-medium text-gray-900 dark:text-gray-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400">默认 404</span>
                 ...
                 <label class="flex items-center cursor-pointer group">
                   ...
                   <div class="ml-3">
                      <span class="block text-sm font-medium text-gray-900 dark:text-gray-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400">URL 跳转</span>
             ...
             <div class="flex items-start gap-2 text-xs text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 p-2 rounded">
