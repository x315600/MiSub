...
<template>
  <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 glass-panel p-6 rounded-3xl border border-white/20 dark:border-white/5 bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl">
