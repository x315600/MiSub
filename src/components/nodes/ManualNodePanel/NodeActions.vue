...
<template>
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-4">
    ...
    <div class="flex items-center gap-2 w-full sm:w-auto">
      ...
      <button @click="emit('add')" class="text-sm font-semibold px-4 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white transition-colors shadow-xs shrink-0">新增</button>
