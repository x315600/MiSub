    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="pt-safe-top">
        ...
        <div v-if="isLoggedIn" class="flex items-center space-x-2 sm:space-x-3">
          ...
          <!-- 代理服务插件按钮 -->
          <button @click="uiStore.showProxySettings()" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white smooth-all hover:scale-110 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800" title="代理服务插件">
